...
public final class GetOperationException extends GenericCodedException {
    ...
    */
    public GetOperationException(final EnumErrorCatalog err, final String... args) {
     ...
     * @param args Optional arguments for the text error message.
     */
    public GetOperationException(final EnumErrorCatalog err, final Exception cause, final String... args) {
     ...
     */
    public GetOperationException(final GenericCodedException other) {
        super(other);
    }
}
