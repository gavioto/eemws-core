...
public final class ListOperationException extends GenericCodedException {
	 ...
	 */
	public ListOperationException(final EnumErrorCatalog err, final String ... args) {
	 ...
	 * @param args Optional arguments for the text error message.
	 */
	public ListOperationException(final EnumErrorCatalog err, final Exception cause, final String ... args) {
     ...
     */
    public ListOperationException(final GenericCodedException other) {
        super(other);
    }
}
